...
<div class="container">
            ...
            <div class="group-form">
                <input type="text" id="pseudo" class="fat" name="pseudo" required>
                <label class="check">Identifiant</label>
				
            </div>
            <div class="group-form">
                <input type="password" id="mdp" class="fat" name="mdp" id="password" required>
                <label>Mot de passe</label>
				
            </div>
            <div class="group-form text-center">
                <button type="submit" class="fat-send" name="connexion">CONNEXION</button>
               
                
            </div>

            <div class="group-form text-center">
              <a href="inscription.php"><div type="button" class="fat-send">INSCRIPTION</div></a>
            </div>
