$(document).ready(function () {
    ...
    function convertir_smiley() {
        $('#message_tchat p').each(function () {
            ...
            $('#message_tchat').html($('#message_tchat').html().replace('^1', '<img class="smiley" src="smil/like.png" alt="like">'));
            $('#message_tchat').html($('#message_tchat').html().replace('^2', '<img class="smiley" src="smil/dislike.png" alt="dislike">'));
            $('#message_tchat').html($('#message_tchat').html().replace('^3', '<img class="smiley" src="smil/linkedin.png" alt="linkedin">'));
            $('#message_tchat').html($('#message_tchat').html().replace('^4', '<img class="smiley" src="smil/youtube.png" alt="youtube">'));
            $('#message_tchat').html($('#message_tchat').html().replace('^5', '<img class="smiley" src="smil/facebook.png" alt="facebook">'));
            $('#message_tchat').html($('#message_tchat').html().replace('^6', '<img class="smiley" src="smil/whatsapp.png" alt="whatsapp">'));
            $('#message_tchat').html($('#message_tchat').html().replace('^7', '<img class="smiley" src="smil/snapchat.png" alt="snapchat">'));
            $('#message_tchat').html($('#message_tchat').html().replace('^8', '<img class="smiley" src="smil/twitter.png" alt="twitter">'));
            $('#message_tchat').html($('#message_tchat').html().replace('^9', '<img class="smiley" src="smil/tiktok.png" alt="tiktok">'));
